 ...
 * @author azizo
 */
public class FrontRegistrationController implements Initializable {
    ...
    try {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("FrontLogin.fxml"));
        Parent root = loader.load();
        Scene scene = new Scene(root);
        Stage stage = (Stage) full_nameF.getScene().getWindow();
